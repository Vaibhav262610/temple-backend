...
router.post('/', async (req, res) => {
  try {
    ...
    const donorName = req.body.donor_name || req.body.name || null;
    const donorEmail = req.body.donor_email || req.body.email || null;
    ...
    const donationData = {
      ...
      // If no trigger exists, we'll generate it here
